...
unique_ptr_t(CStructDeclaration) make_CStructDeclaration(
    TIdentifier tag, bool is_union, bool is_packed,
    vector_t(unique_ptr_t(CMemberDeclaration)) * members, size_t info_at);
...
unique_ptr_t(CFunctionDeclaration) make_CFunctionDeclaration(TIdentifier name, vector_t(TIdentifier) * params,
    unique_ptr_t(CBlock) * body, shared_ptr_t(Type) * fun_type, const CStorageClass* storage_class,
    bool has_section, TIdentifier section, size_t info_at);
...
unique_ptr_t(CVariableDeclaration) make_CVariableDeclaration(TIdentifier name, unique_ptr_t(CInitializer) * init,
    shared_ptr_t(Type) * var_type, const CStorageClass* storage_class,
    bool has_section, TIdentifier section, size_t info_at);
